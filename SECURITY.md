...
Runtime identity and state must be mounted or provided externally. Image publishing is restricted to pushes on `main`. PRs scan the locally built image before publishing is possible.
